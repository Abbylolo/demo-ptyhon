...
a = int(input('a:'))
b = int(input('b:'))
print(a-b if (a-b) % 2 == 1 else '"a-b的结果不是奇数')
'''
...
'''
a = int(input('a:'))
ans = (a // 100) ** 3 + (a // 10 % 10) ** 3 + (a % 10) **3
print('是水仙花数' if a == ans else '不是水仙花数')
'''
...
'''
a = int(input('a:'))
print('是回文数' if a // 10000 == a % 10 and a // 1000 % 10 == a // 10 % 10 else '不是回文数')
'''
...
# and year % 100 != 0 等价于 and not year % 100 == 0
print('闰年' if (year % 4 == 0 and not year % 100 == 0) or year % 400 == 0 else '平年')
'''
...
stand = (height - 108) * 2
print('合适' if stand - 10 <= weight <= stand + 10 else '不合适')
'''
